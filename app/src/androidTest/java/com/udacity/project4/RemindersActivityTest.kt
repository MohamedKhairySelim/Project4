...
class RemindersActivityTest :
    ...
    fun reminder_Location_Activity_show_toast_message() {
        ...
        onView(withId(R.id.save_Reminder_Location_btn)).perform(click())
    ...
    fun reminder_Location_Activity_show_Snackbar_message() {
        ...
        onView(withId(R.id.save_Reminder_Location_btn)).perform(click())
        onView(withId(R.id.saveReminder)).perform(click())
        onView(withId(com.google.android.material.R.id.snackbar_text)).check(ViewAssertions.matches(withText(R.string.saveReminderErrorExplanation)))
        activityScenario.close()
    }
}