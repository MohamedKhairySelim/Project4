...
class RemindersLocalRepositoryTest {
    ...
    @Before
    fun setup() {
        remindersDatabase = Room.inMemoryDatabaseBuilder(InstrumentationRegistry.getInstrumentation().context, RemindersDatabase::class.java).allowMainThreadQueries().build()
    ...
    fun insertThreeReminders_getAllThreeFromDatabase() = runBlocking {
        val reminder1 = ReminderDTO("title1", "description1", "somewhere1", 11.0, 11.0, "random1")
        val reminder2 = ReminderDTO("title2", "descriptio2n", "somewhere2", 12.0, 12.0, "random2")
        val reminder3 = ReminderDTO("title3", "description3", "somewhere3", 13.0, 13.0, "random3")
